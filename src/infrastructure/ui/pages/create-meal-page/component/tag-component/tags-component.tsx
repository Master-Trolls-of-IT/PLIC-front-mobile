...
import useTagComponentData from '~/infrastructure/ui/pages/create-meal-page/component/tag-component/hooks';
import TagsComponentStyle from '~/infrastructure/ui/pages/create-meal-page/component/tag-component/tags-component-style';
import { TagsComponentProps } from '~/domain/interfaces/props/tags-component-props';
...
const TagsComponent = ({ tag, isCross, mealTagsSelected, dispatch }: TagsComponentProps) => {
    const {
        ...
        onPressTagCross,
        onPressTagContainer
    } = useTagComponentData({ tag, isCross, mealTagsSelected, dispatch });
