...
import SettingsPageBlobsBottom
    from '~/infrastructure/ui/pages/settings-page/component/background/settings-page-blobs-bottom';
        ...
        <View style={SettingsPageStyle.container}>
            ...
            <View style={SettingsPageStyle.contentContainer}>
                ...
                <View style={SettingsPageStyle.links}>
                    ...
                    <GenericButton title="Se déconnecter" onPress={() => {
                    }} style={logoutButtonStyle}/>
                    <GenericButton title="Supprimer le compte" onPress={onDeleteAccountPress}
                ...
                <CustomModal
                    ...
                    <View style={SettingsPageStyle.deleteAccount1TextContainer}>
                        <Text style={SettingsPageStyle.deleteAccount1Text}>Vous êtes sur le point de supprimer votre compte. Veuillez entrer votre mot de passe ci-dessous pour confirmer:</Text>
                    </View>
                    <GenericInput
                ...
                <CustomModal
                    ...
                    customStyle={true}>
                    <View style={SettingsPageStyle.deleteAccount1TextContainer}>
                        <Text style={SettingsPageStyle.deleteAccount1Text}>Êtes-vous absolument certain de vouloir supprimer votre compte ? Cette action est irréversible.</Text>
                    </View>
                    <View style={SettingsPageStyle.buttonContainer}>
                        <GenericButton
                            title="Annuler"
