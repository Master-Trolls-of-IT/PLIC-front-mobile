...
function App() {
    ...
    return (
        <View style={{ justifyContent: 'center', alignItems: 'center', marginTop: 250 }}>
            <LargeIntakes
                energy={{ nutrientType: NutrientsEnum.Energy, goal: 2050, earned: 1620 }}
                firstNutrient={{ nutrientType: NutrientsEnum.Protein, goal: 79, earned: 62 }}
                secondNutrient={{ nutrientType: NutrientsEnum.Carbohydrate, goal: 53, earned: 12 }}
                thirdNutrient={{ nutrientType: NutrientsEnum.Fiber, goal: 23, earned: 15 }}
            />
